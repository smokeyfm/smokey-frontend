  ...
  return (
    <div className="fp-modal-container">
      ...
      <div className="fp-modal-content-container">
        ...
        <p>
          The company uses the personal information in the file we maintain about you, and other
          information we obtain from your current and past activities on the website.
        </p>
        <p>
          (1) to deliver the products that you have requested; (2) to manage your account and
          provide you with customer support; (3) to communicate with you by email, telephone and/or
          mobile devices about products that may be of interest to you; (4) to inform you of
          updates; (5) to detect and protect us against error and fraud. We may use financial
          information or payment method to process payment for any purchases made on the website.
        </p>
        <p>
        ...
        <p>
          Users should regularly check this page for any changes to this Privacy Policy. However,
          company may, as determined in its discretion, decide to notify users of changes made to
        ...
        <p>
          The company recognizes that it must use customer information responsibly. Your information
          is contained behind secured networks and is only accessible by a limited number of
          persons, and they are required to keep the information confidential.
        </p>
      </div>
    </div>
  );
